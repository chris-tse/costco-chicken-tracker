...
import { Route as PrototypeCaptureRouteImport } from './app/prototype/capture'
...
const PrototypeCaptureRoute = PrototypeCaptureRouteImport.update({
  id: '/prototype/capture',
  path: '/prototype/capture',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/prototype/capture': typeof PrototypeCaptureRoute
...
export interface RootRouteChildren {
  ...
  PrototypeCaptureRoute: typeof PrototypeCaptureRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/prototype/capture': {
      id: '/prototype/capture'
      path: '/prototype/capture'
      fullPath: '/prototype/capture'
      preLoaderRoute: typeof PrototypeCaptureRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/_protected/app': {
      id: '/_protected/app'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  PrototypeCaptureRoute: PrototypeCaptureRoute,
